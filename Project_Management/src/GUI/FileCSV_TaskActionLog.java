...
public class FileCSV_TaskActionLog extends javax.swing.JFrame {
    ...
    public void Show() {
        ...
        if (List_Project_Interface.STEP3 == 1) {
            for (Task task : con.task) {
                if (task.getProjectId() == List_Task_Interface.IDproject) {
                    jTextArea1.append(task.toString());
                    for (TaskActionLog_ t : c.logs) {
                        if (task.getID()==t.getID_task())
    ...
    private void initComponents() {
        ...
        jLabel1.setText("File CSV TaskActionLog");
